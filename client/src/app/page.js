        ...
        <Row className={style.serviceContainer}>
          ...
          <Col xs={6} md={3}>
            <div className={style.serviceItem}>
              ...
              <GoRocket size={'5em'} />
              <p>EMS Hỏa tốc là là dịch vụ chất lượng cao có chỉ tiêu thời gian toàn trình rút ngắn so với dịch vụ EMS Tài liệu/Hàng hóa nhanh, trong đó bưu gửi được ưu tiên chuyển phát đến người nhận trong khung thời gian cam kết theo tuyến hành trình cụ thể.</p>
            </div>
          </Col>
          <Col xs={6} md={3} >
            <div className={style.serviceItem}>
      ...
      <Container className={style.aboutUs} fluid>
        <Row>
          <Col xs={5} className={style.aboutUsTitle}>
            <h2>Về chúng tôi</h2>
            <p>J&T Express là thương hiệu chuyển phát nhanh dựa trên sự phát triển của công nghệ và Internet. Chúng tôi sở hữu mạng lưới rộng khắp nhằm hỗ trợ các hoạt động giao nhận hàng hóa nhanh chóng không chỉ ở nội thành mà còn ở ngoại thành và các vùng xa của các tỉnh thành trong cả nước Việt Nam.</p>
          </Col>
          <Col xs={6} className={style.aboutUsWrapperItem}>
            ...
            <Row>
              ...
              <Col>
                ...
                <p>Mạng lưới bưu cục rộng khắp hoạt động trên toàn quốc</p></Col>
            </Row>
          </Col>
        </Row>
      </Container>
